...
// 	$sqlFol1=mysqli_query($conn,"select * from book_order where confirm_status=1  and shipping_status in (0,1) order by id desc");
	$sqlFol1=mysqli_query($conn,"SELECT order_product.*, book_order.*
                                    ...
                                    WHERE order_product.status='2' AND seller.availability='no'
...
<div class="content-body">
	...
	<?php//	}elseif($rowOrder['shipping_status']=='1')	{	?>
		<!--<span class="label label-info" >Processing</span>-->

	<?php//	}	elseif($rowOrder['shipping_status']=='2')	{	?>
		<!--<span class="label label-success" >Complete</span>-->

	<?php	//}	elseif($rowOrder['shipping_status']=='3')	{	?>
...
<td class="d-flex align-items-center">
        <a class="btn btn-success" href="complete_single_order.php?orderid=<?php echo $rowOrder['booked_id']?>" >View </a>
</td>
