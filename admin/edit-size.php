...
<!-- 
                    <div class="form-group">
                      <label for="exampleInputEmail1">Arabic Size Name</label>
                      <input type="text" class="form-control" id="" value="<?php echo $row1['ar_name'];?>" placeholder="Enter category name" name="size_arabic" value="" required>
                    </div> -->
