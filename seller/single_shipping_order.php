...
$fetchsingleorder=mysqli_query($conn, "select * from order_product where booking_id='".$_GET['orderid']."' and seller_id='".$_SESSION['seller_id']."' and status=1");
...
$sellercheck=mysqli_fetch_row($sql);
				   ...
				   <?php } ?>
							...
							<p>
							    Order Status : <?php if($single['status']=='0') { ?>
                                            ...
                                            <strong style="color:orange">Processing</strong>
        	...
        	<div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <p><b>User Email:</b> <?php echo $single['useremail'];?> </p> <p><b>User City: </b><?php echo $single['city'];?> </p>
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table id="example">
								...
								<?php if($rowsingleorder['payment_status']==0){?><td>Pending</td> <?php } if($rowsingleorder['payment_status']==1){ ?> <td>Complete</td> <?php }?>
								
								<?php if($sellercheck['availability']=='no'||'No'){?><td>Delivery by Admin</td><?}elseif($sellercheck['availability']=='yes'||'Yes'){?>
								<td>
		   ...
		   <br/>
		     ...
		     <div class="form-group">
    		    <select class="form-control" id="update_status_id<?php echo $rowsingleorder['orderid']?>" onchange="updateStatus('<?php echo $rowsingleorder['orderid']?>')">
                    ...
                    <option value="2" <?php if($rowsingleorder['status']=='2') echo 'selected' ;?>>Complete</option>
                </select>
            </div>
...
var booking_id='<?php echo $single['booked_id']?>';
var datastring='status='+status+'&order_id='+id+'&sellerr_id='+seller_id+'&booking_id='+booking_id;
