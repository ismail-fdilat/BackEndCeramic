...
include('nav.php');
	...
	$sqlFol1=$conn->query("select * from social_links ");
...
if(isset($_GET['delid']))
{
	...
	if($sqlD)
	{
		...
		echo '<script>window.location.href="edit-social.php?sucmsg=Cms Deleted"</script>';
	}
	else
	{
                  ...
                  <table id="example1" class="table table-bordered table-striped" style="text-align:center">
					...
					while($rowS=$sqlFol1->fetch())
					{
                      ...
                      <tr>
                        ...
                        <td style="color:red;text-align:left; text-transform:uppercase"><?php echo $rowS['title']?> </td>
					
						 
						 
			
					   <td ><a href="edit-social.php?editid=<?php echo $rowS['id']?>"><i class="fa fa-edit"></i> Edit Link</a></td>
